         ...
         <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
          ...
          <div class="collapse navbar-collapse " id="menu">
              <ul class="navbar-nav ms-auto  ">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="../demo_page/demo.html">Demo</a>
                  </li>
                   <li class="nav-item">
                      ...
                      <a class="nav-link nav-link-custom  d-none d-lg-block px-3" href="signUp.php">SIGN UP NOW</a>   
         ...
         <div class="container my-5 ">
             <div class="row gx-0">
                 ...
                 <div class="col-lg-7 col-md-7 col-12 px-5 pt-5">
                     ...
                     <h4>Create your Farm House account</h4>
                     <form action="signUpData.php" method="post">
                         <div class="form-row">
                             <div class="col-lg-7 col-md-7 col-12 ">
                                 <input type=" text" placeholder="Username" class="form-control my-3 p-2" name="uname" required>
                             </div>
                         </div>
                         <div class="form-row">
                             <div class="col-lg-7 col-md-7 col-12">
                         ...
                         <div class="form-row">
                             <div class="col-lg-7 col-md-7 col-12">
                                 <input type="password" placeholder="Confirm Password" class="form-control my-3 p-2" name="cpass" required>
                             </div>
                         </div>
                         <div class="form-row">
                             <div class="col-lg-7 col-md-7 col-12">
                                 <input type="email" placeholder="email" class="form-control my-3 p-2" name="email" required>
                             </div>
                         </div>
                         <div class="form-row">
                             <div class="col-lg-7 col-md-7 col-12">
